...
- [AOL-archive/cyclops](https://github.com/AOL-archive/cyclops) - An advanced, but easy to use, platform for writing functional applications in Java 8.
...
- [kyay10/KonTinuity](https://github.com/kyay10/KonTinuity) - Provides delimitied continuations in Kotlin with Coroutines
...
- [xorq-labs/xorq](https://github.com/xorq-labs/xorq) - Git-native executable memory for agentic data work.
